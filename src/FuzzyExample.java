...
public static void main(String[] args) throws Exception {
    try {
        String fileName = "fuzzy.fcl"; //args[0];
        int poziomNatezenia = 50; //Integer.parseInt(args[1]);
        int poraDnia = 23; //Integer.parseInt(args[2]);
        ...
        System.out.println(fuzzyRuleSet.getVariable("zmiana_natezenia"));
